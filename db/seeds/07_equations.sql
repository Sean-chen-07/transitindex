...
INSERT INTO core.metric_equations (equation_code, kind, defines, display) VALUES
  ...
  ('average_fare_def',           'ratio', 'average_fare',           'average_fare = farebox_revenue / ridership'),
  ...
  ('farebox_recovery_def',       'ratio', 'farebox_recovery_ratio', 'farebox_recovery_ratio = farebox_revenue / operating_expenses'),
