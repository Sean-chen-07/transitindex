...
INSERT INTO core.metrics (code, display_name, unit, unit_type, is_derived, formula, higher_is_better) VALUES
  ...
  ('average_fare',             'Average Fare',              'CAD',      'currency', true,  'total_revenue_excluding_subsidy / ridership',                     NULL),
  ...
  ('farebox_recovery_ratio',   'Farebox Recovery Ratio',    '%',        'ratio',    true,  'total_revenue_excluding_subsidy / operating_expenses',            NULL),
